...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    this.$root.$on('alert', function (object) {
      _this.alert = Object.assign(_this.alert, object);
      setTimeout(function () {
        return _this.alert.show = false;
      }, 2000);
    });
  }
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getDateName: function getDateName(date) {
      var dateName;
      var fromDate = new Date(date.from);
      var toDate = new Date(date.to);
      var fromMonth = this.monthNames[fromDate.getMonth()];
      var toMonth = this.monthNames[toDate.getMonth()];
      var fromYear = fromDate.getFullYear();
      var toYear = toDate.getFullYear();

      if (fromMonth === toMonth && fromYear === toYear) {
        dateName = "".concat(fromMonth, " ").concat(fromYear);
      } else if (fromMonth !== toMonth && fromYear === toYear) {
        dateName = "".concat(fromMonth, " - ").concat(toMonth, " ").concat(toYear);
      } else {
        dateName = "".concat(fromMonth, " ").concat(fromYear, " - ").concat(toMonth, " ").concat(toYear);
      }

      return dateName;
    },
    getDefaultDateName: function getDefaultDateName() {
      var dateCoverLength = _.filter(this.dates, {
        change_date_name: true
      }).length;

      var currentDate = new Date();

      if (dateCoverLength > 0) {
        this.dateName = "".concat(this.monthNames[currentDate.getMonth()], " - ").concat(this.monthNames[currentDate.getMonth() + dateCoverLength], " ").concat(currentDate.getFullYear());
      } else {
...
window.PopperJs = popper_js__WEBPACK_IMPORTED_MODULE_6__.default;
window.Form = _utils_Form__WEBPACK_IMPORTED_MODULE_2__.default;
...
var Errors = /*#__PURE__*/function () {
  ...
  _createClass(Errors, [{
    ...
    value: function has(field) {
      var fieldArray = this.normalizeToArray(field);
      var result = this.errors;

      while (fieldArray.length > 0) {
        var fieldPart = fieldArray.shift();
    ...
    key: "inputMessage",
    value: function inputMessage(field) {
      if (!this.has(field)) {
        return;
      }

      return _defineProperty({}, this.get(field), this.has(field));
    }
  }, {
    key: "inputType",
    value: function inputType(field) {
      if (!this.has(field)) {
        return;
      }

      return {
        'is-danger': this.has(field)
      };
    }
  }, {
    key: "normalizeToArray",
    value: function normalizeToArray(value) {
    ...
    key: "buildNestedObject",
    value: function buildNestedObject(fieldParts, message, existingObj) {
      fieldParts.reverse();

      while (fieldParts.length > 0) {
        var obj = {};
        var fieldPart = fieldParts.shift();
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function submit(requestType, url) {
      ...
      var method = requestType.toLowerCase();
      var data = this.data();
      return new Promise(function (resolve, reject) {
        window.axios.request({
          ...
          if (response.status === 422) {
            _this.onError(response.data.errors);
          }
    ...
    key: "resetExcept",
    value: function resetExcept(exceptions) {
      for (var key in this.originalData) {
        if (key === exceptions) {
          continue;
        }
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true&":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".listing-group-date .listing-date-content[data-v-052a41a9] {\n  max-height: 500px;\n  overflow-y: auto;\n}\n.listing-group-date .list-group-item[data-v-052a41a9] {\n  border-right-width: 0;\n  border-left-width: 0;\n}", ""]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Index.vue?vue&type=style&index=0&lang=scss&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Index.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".b-calendar-grid:focus {\n  border-color: #ced4da !important;\n  box-shadow: none !important;\n}\n.form-group label {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n.checkbox-group {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n}\n.checkbox-group .custom-control {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n.checkbox-group .custom-control:last-child {\n  margin-right: 0 !important;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/* harmony import */ var _Calendar_vue_vue_type_style_index_0_id_052a41a9_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true& */ "./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/* harmony import */ var _Index_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Index.vue?vue&type=style&index=0&lang=scss& */ "./resources/js/views/Index.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true&":
/*!********************************************************************************************************!*\
  !*** ./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true& ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_0_rules_0_use_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12[0].rules[0].use[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&lang=scss&scoped=true&");
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("h1", [_vm._v(_vm._s(_vm.dateName))]),
    _vm._v(" "),
    _c("div", { staticClass: "listing-group-date" }, [
      _c(
        "div",
        { staticClass: "listing-date-content" },
        _vm._l(_vm.dates, function(dateObj, index) {
          return _c(
            "b-list-group-item",
            { key: index, attrs: { variant: dateObj.name ? "success" : "" } },
            [
              _c(
                "b-row",
                [
                  _c("b-col", { attrs: { lg: "3" } }, [
                    _vm._v(
                      "\n            " +
                        _vm._s(_vm.formatListingDate(dateObj.date)) +
                        "\n          "
                    )
                  ]),
                  _vm._v(" "),
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("nav", { staticClass: "navbar navbar-dark bg-dark mb-4" }, [
    _c(
      "div",
              ...
              _c("b-col", { attrs: { lg: "6" } }, [
                _c(
                  ...
                  [
                    _c(
                      "b-form-group",
                      { attrs: { label: "Event", "label-for": "name" } },
                      [
                        _c("b-form-input", {
                        ...
                        _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                staticClass:
                                  "checkbox-group d-lg-flex justify-content-lg-between",
                                attrs: { name: "days" },
                                model: {
                                  value: _vm.form.days,
                                  callback: function($$v) {
                            ...
                            _vm.form.errors.has("days")
                              ? _c(
                                  "div",
                                  {
                                    staticClass: "invalid-feedback",
                                    class: {
                                      "d-block": _vm.form.errors.has("days")
                                    }
                                  },
                                  [
                                    _vm._v(
                                      "\n                " +
                                        _vm._s(_vm.form.errors.get("days")) +
                                        "\n              "
                                    )
                                  ]
                                )
